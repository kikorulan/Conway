...
#======================================================
# MPI with 4 processors (4 threads)
#======================================================

# Example 1
START_TIME=$(($(date +%s%N)/1000000))
mpirun -n 4 ./runConwayMPI Example1_dimensions.dat Example1_domain.dat
END_TIME=$(($(date +%s%N)/1000000))
ELAPSED_TIME=$(($END_TIME - $START_TIME))
...
# Example 2
START_TIME=$(($(date +%s%N)/1000000))
mpirun -n 4 ./runConwayMPI Example2_dimensions.dat Example2_domain.dat
END_TIME=$(($(date +%s%N)/1000000))
ELAPSED_TIME=$(($END_TIME - $START_TIME))
...
# Example 3
START_TIME=$(($(date +%s%N)/1000000))
mpirun -n 4 ./runConwayMPI Example3_dimensions.dat Example3_domain.dat
END_TIME=$(($(date +%s%N)/1000000))
ELAPSED_TIME=$(($END_TIME - $START_TIME))
echo "20000 $ELAPSED_TIME" >> performance_mpi.dat
# Example 4
START_TIME=$(($(date +%s%N)/1000000))
mpirun -n 4 ./runConwayMPI Example4_dimensions.dat Example4_domain.dat
END_TIME=$(($(date +%s%N)/1000000))
ELAPSED_TIME=$(($END_TIME - $START_TIME))
...
# Example 5
START_TIME=$(($(date +%s%N)/1000000))
mpirun -n 4 ./runConwayMPI Example5_dimensions.dat Example5_domain.dat
END_TIME=$(($(date +%s%N)/1000000))
ELAPSED_TIME=$(($END_TIME - $START_TIME))
...
plot 'performance_serial.dat' using 1:2 with lines linetype rgb "#00FFFF" title "Serial" , \
     'performance_omp.dat'    using 1:2 with lines linetype rgb "#FF00FF" title "MPI with 4 threads"
EOF
